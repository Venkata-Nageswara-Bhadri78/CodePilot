...
class AutomatedJobExtractionProductionSecurityTest {
    ...
    @Test
    void swaggerAutomatedJobExtractionDocs_onProduction_areNotPublic() throws Exception {
        MvcResult result = mockMvc.perform(get("/v3/api-docs/automated-job-extraction")).andReturn();
