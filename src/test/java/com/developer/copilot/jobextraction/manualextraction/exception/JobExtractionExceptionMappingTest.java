package com.developer.copilot.jobextraction.manualextraction.exception;
...
class JobExtractionExceptionMappingTest {
    ...
    void parseRateLimit_is429WithRetryAfter() {
        ResponseEntity<ApiResponse<Void>> response = handler.handleJobExtractionRateLimitExceeded(
                new com.developer.copilot.jobextraction.manualextraction.ratelimit.exception.RateLimitExceededException(9));
