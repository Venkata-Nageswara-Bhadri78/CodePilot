 ...
 */
@Slf4j
public class CommonRateLimitServiceImpl implements CommonRateLimitService {
    ...
    public CommonRateLimitServiceImpl(CommonRedisService redisService) {
    ...
    public RateLimitResult consume(String bucket, String identity, int limit, long windowSeconds) {
        ...
        if (redisService != null) {
            try {
                ...
                log.warn("Common Redis rate-limit failed; using in-memory fallback: {}", ex.getMessage());
            }
        }
