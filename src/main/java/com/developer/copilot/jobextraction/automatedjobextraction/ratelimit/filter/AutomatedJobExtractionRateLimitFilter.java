...
/**
 * Per-IP and per-user limits on {@code /api/v1/automated-job-extraction/**}. Runs after
 * the security chain so a stolen JWT is keyed by user id, not only by source IP.
 */
public class AutomatedJobExtractionRateLimitFilter extends OncePerRequestFilter {

    private static final String PATH_PREFIX = "/api/v1/automated-job-extraction";
    private static final long WINDOW_SECONDS = 60L;

    private final AutomatedJobExtractionRateLimitProperties properties;
    private final AutomatedJobExtractionRateLimitService rateLimitService;
    private final ObjectMapper objectMapper;

    public AutomatedJobExtractionRateLimitFilter(
            AutomatedJobExtractionRateLimitProperties properties,
            AutomatedJobExtractionRateLimitService rateLimitService) {
